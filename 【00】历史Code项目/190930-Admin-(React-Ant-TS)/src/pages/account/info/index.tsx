...
interface MerchantInfoProps extends FormComponentProps {
  merchantInfo: StateType;
...
class MerchantInfo extends Component<MerchantInfoProps> {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'merchantInfo/fetchMerchantInfo',
    });
  }
                ...
                <Col lg={6} md={12} sm={24}>
                  <Form.Item label={fieldLabels.name}>
                    {getFieldDecorator('Name', {
                      initialValue: merchantInfo.merchant.Name,
...
export default Form.create<MerchantInfoProps>()(MerchantInfo);
